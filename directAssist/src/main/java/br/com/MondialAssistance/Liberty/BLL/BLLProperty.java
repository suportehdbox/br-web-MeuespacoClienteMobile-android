...
import br.com.MondialAssistance.Liberty.WS.Property;
...
public class BLLProperty {
	...
	public PropertyPolicy getPolicy(Context context, String zipcode, String document, long clientID) throws Exception {
		...
		try {
			br.com.MondialAssistance.Liberty.WS.GetPropertyPoliciesResult getPropertyPolicies;
			Address address;
	...
	public Vector<PropertyPolicy> getListPolicies(Context context, String deviceUID, Integer manufacturerID, long clientID) throws Exception {
		...
		try {
			br.com.MondialAssistance.Liberty.WS.ListPropertyPoliciesResult listPropertyPolicies;
			...
			for (br.com.MondialAssistance.Liberty.WS.PropertyPolicy item : listPropertyPolicies.getPropertyPolicies()) {
	...
	public Vector<Case> getListCases(Context context, String deviceUID, Integer manufacturerID, long clientID) throws Exception {
		...
		try {
			br.com.MondialAssistance.Liberty.WS.ListPropertyCasesResult listPropertyCases;
			Case caseItem;
			...
			for (br.com.MondialAssistance.Liberty.WS.Case item : listPropertyCases.getCases()) {
