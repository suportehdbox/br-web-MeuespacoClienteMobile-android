...
import br.com.MondialAssistance.DirectAssist.MDL.Location;
import br.com.MondialAssistance.DirectAssist.MDL.Provider;
import br.com.MondialAssistance.DirectAssist.MDL.ServiceDispatch;
...
import br.com.MondialAssistance.DirectAssist.WS.DirectAssistWS;
...
public class BLLDirectAssist {
	...
	public ServiceDispatchCase getDispatchStatus(Context context, Integer caseNumber, Integer requestID, long clientID) throws Exception {
		...
		try {
			br.com.MondialAssistance.DirectAssist.WS.GetServiceDispatch serviceDispatchResult;
