...
import br.com.MondialAssistance.DirectAssist.MDL.Point;
import br.com.MondialAssistance.DirectAssist.Util.Utility;
import br.com.MondialAssistance.DirectAssist.WS.MapLink.AddressFinder;
...
public class BLLAddressFinder {
	...
	public AddressLocation getAddress(Double latitude, Double longitude) throws Exception 
	{
		...
		br.com.MondialAssistance.DirectAssist.WS.MapLink.Point pointWS = new br.com.MondialAssistance.DirectAssist.WS.MapLink.Point();
		br.com.MondialAssistance.DirectAssist.WS.MapLink.AddressLocation addressLocationWS;
		Point point;
	...
	public Vector<AddressLocation> FindAddressByStreet(String streetName, String cityName) throws Exception 
	{
		...
		br.com.MondialAssistance.DirectAssist.WS.MapLink.AddressOptions addressOptions;
		br.com.MondialAssistance.DirectAssist.WS.MapLink.AddressInfo addressInfo;
		br.com.MondialAssistance.DirectAssist.WS.MapLink.ResultRange resultRange;
		br.com.MondialAssistance.DirectAssist.WS.MapLink.Address addressWS;
		br.com.MondialAssistance.DirectAssist.WS.MapLink.City cityWS;
		
		resultRange = new br.com.MondialAssistance.DirectAssist.WS.MapLink.ResultRange();
		resultRange.setrecordsPerPage(100);
		resultRange.setpageIndex(1);
		
		addressOptions = new br.com.MondialAssistance.DirectAssist.WS.MapLink.AddressOptions();
		...
		cityWS = new br.com.MondialAssistance.DirectAssist.WS.MapLink.City();
		cityWS.setname(cityName);
		
		addressWS = new br.com.MondialAssistance.DirectAssist.WS.MapLink.Address();
		...
		for (br.com.MondialAssistance.DirectAssist.WS.MapLink.AddressLocation item : addressInfo.getaddressLocation()) {
	...
	public Point getXY(Address address) throws Exception 
	{
		...
		br.com.MondialAssistance.DirectAssist.WS.MapLink.Address addressWS;
		br.com.MondialAssistance.DirectAssist.WS.MapLink.Point pointWS;
		br.com.MondialAssistance.DirectAssist.WS.MapLink.City city;
		
		city = new br.com.MondialAssistance.DirectAssist.WS.MapLink.City();
	...
	public java.util.Vector<AddressLocation> getCrossStreetAddress(Double latitudde, Double longitude) throws Exception 
	{
		...
		br.com.MondialAssistance.DirectAssist.WS.MapLink.Point pointWS = new br.com.MondialAssistance.DirectAssist.WS.MapLink.Point();
		java.util.Vector<br.com.MondialAssistance.DirectAssist.WS.MapLink.AddressLocation> AddressLocationsWS;
		AddressLocation addressLocation;
		Point point;
		...
		for (br.com.MondialAssistance.DirectAssist.WS.MapLink.AddressLocation item : AddressLocationsWS) {
