...
import br.com.MondialAssistance.DirectAssist.MDL.Phone;
import br.com.MondialAssistance.DirectAssist.MDL.Vehicle;
import br.com.MondialAssistance.DirectAssist.Util.ErrorHelper;
import br.com.MondialAssistance.DirectAssist.Util.LogHelper;
import br.com.MondialAssistance.DirectAssist.WS.Automotive;
...
public class BLLAutomotive {
	...
	public Vector<AutomotivePolicy> getListPolicies(Context context, String deviceUID, Integer manufacturerID, long clientID) throws Exception {
		...
		try {
			...
			br.com.MondialAssistance.DirectAssist.WS.ListPoliciesResult listPolicies;
			...
			for (br.com.MondialAssistance.DirectAssist.WS.AutomotivePolicy item : listPolicies.getAutomotivePolicies()) {
	...
	public Vector<AutomotiveCase> getListCases(Context context, String deviceUID, Integer manufacturerID, long clientID) throws Exception {
		...
		try {
			...
			br.com.MondialAssistance.DirectAssist.WS.ListAutomotiveCasesResult listAutomotiveCases;
			...
			for (br.com.MondialAssistance.DirectAssist.WS.AutomotiveCase item : listAutomotiveCases.getAutomotiveCases()) {
	...
	public Vector<AccreditedGarage> getListAccreditedEstablishment(Context context, Double latitude, Double longitude, long clientID) throws Exception {
		...
		try {
			...
			br.com.MondialAssistance.DirectAssist.WS.ListAccreditedGarages listAccreditedGarages;
			...
			for (br.com.MondialAssistance.DirectAssist.WS.AccreditedGarage item : listAccreditedGarages.getAccreditedGarages()) {
	...
	public AutomotivePolicy getPolicy(Context context, String plate, String document, long clientID) throws Exception {
		...
		try {
			...
			br.com.MondialAssistance.DirectAssist.WS.GetPolicyResult getPolicy;
			Vehicle vehicle;
