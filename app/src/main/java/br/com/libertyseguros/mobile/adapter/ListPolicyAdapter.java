...
public class ListPolicyAdapter extends BaseAdapter {
    ...
    private PolicyBeansV2.InsurancesV2 list[];

    public ListPolicyAdapter(Context context, PolicyBeansV2 list){
        this.context = context;
        this.list = list.getInsurances();
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        for (int j = 0; j < list[i].getItens().length; j++) {
            ...
            tvDescription.setText(list[i].getItens()[j].getDescription());
