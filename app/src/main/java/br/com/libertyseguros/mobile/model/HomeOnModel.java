...
public class HomeOnModel extends BaseModel {
    ...
    public boolean isLogin(Context ctx) {
        ...
        boolean value = loginBeans.getAccess_token() != null;
...
*/
                    try {
                        if (result.contains("ciaCode")) {
                            ...
                            Config.hasAutoPolicy = homeBeans.getInsurance().getBranch().equals(Config.auto);

                            Config.hasHomeAssistance = homeBeans.getInsurance().isAllowPHS();
